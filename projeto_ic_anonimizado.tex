...
Imediatamente após a fricção, os swabs serão acondicionados individualmente em tubos com meio de transporte Stuart identificados com códigos de anonimização (ex. CRT-01, GRD-01, SUP-01, BOM-01). Os tubos serão mantidos sob refrigeração em caixas térmicas (4\celsius{} a 8\celsius{}) e transportados ao laboratório para processamento em até duas horas após a coleta.
