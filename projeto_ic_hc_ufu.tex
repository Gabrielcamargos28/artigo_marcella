...
% --------------------------------------------------
% CAPA (IDENTIFICADA - HC-UFU / UFU)
% --------------------------------------------------
\begin{titlepage}
    \begin{center}
        \textbf{UNIVERSIDADE FEDERAL DE UBERLÂNDIA (UFU)}\\
        \textbf{HOSPITAL DE CLÍNICAS DA UNIVERSIDADE FEDERAL DE UBERLÂNDIA (HC-UFU)}\\
        ...
        \begin{flushleft}
            \begin{spacing}{1.1}
                \textbf{Candidato(a):} [Nome do Estudante] \\
                \textbf{Currículo Lattes:} \url{http://lattes.cnpq.br/1529391952145749} \\
                \textbf{Registro ORCID:} \url{https://orcid.org/0009-0002-2165-9843} \\
                \textbf{Orientador(a):} [Nome do Orientador] \\
                \textbf{Instituição de Execução:} Hospital de Clínicas da UFU (HC-UFU)
            \end{spacing}
        \end{flushleft}
        ...
        \begin{flushright}
            \begin{minipage}{9.5cm}
                \begin{spacing}{1.1}
                    \textit{Projeto de Pesquisa} apresentado como requisito para inscrição no Processo Seletivo de Bolsas de Iniciação Científica do PIC/HU Brasil (Ciclo 2026-2027), a ser desenvolvido no Hospital de Clínicas da UFU.\\
...
% --------------------------------------------------
\section{Resumo}
\noindent As infecções relacionadas à assistência à saúde (IRAS) constituem um grave problema de saúde pública, impactando diretamente a morbimortalidade de pacientes hospitalizados. Embora as superfícies de contato direto (como as mãos dos profissionais de saúde) recebam constante atenção em protocolos de higienização, superfícies de contato indireto e menor vigilância no ambiente hospitalar --- como cortinas divisórias de leitos, grades de camas, suportes de soro e painéis de controle de bombas de infusão --- podem atuar como reservatórios persistentes de patógenos multirresistentes. Este estudo tem como objetivo avaliar a presença e o perfil de multirresistência de bactérias de importância epidemiológica e clínica --- especificamente enterobactérias produtoras de carbapenemase (KPC/CRE), enterococos resistentes à vancomicina (VRE) e \textit{Staphylococcus aureus} resistente à meticilina (MRSA) --- presentes nessas superfícies inanimadas secundárias no Hospital de Clínicas da Universidade Federal de Uberlândia (HC-UFU).
Trata-se de um estudo transversal descritivo no qual serão coletadas 100 amostras das quatro superfícies selecionadas em enfermarias ativas, utilizando swabs estéreis umedecidos em solução salina estéril. As amostras serão submetidas a enriquecimento em caldo BHI e posterior semeadura em meios de cultura seletivos cromogênicos específicos para o isolamento de KPC/CRE, VRE e MRSA. A identificação taxonômica das colônias suspeitas será confirmada por coloração de Gram, testes enzimáticos e série bioquímica convencional. O perfil de susceptibilidade aos antimicrobianos e a confirmação fenotípica dos mecanismos de resistência dos isolados bacterianos serão determinados pelo método de disco-difusão em ágar (Kirby-Bauer), em conformidade com as diretrizes vigentes do BrCAST/EUCAST. Como o estudo envolve exclusivamente superfícies físicas, inanimadas e coletivas de ambiente de livre circulação, não há coleta de material de seres humanos ou identificação de pacientes, dispensando a submissão prévia ao Comitê de Ética em Pesquisa (CEP), o que agiliza sua exequibilidade. Espera-se com este estudo mapear a dispersão ambiental de patógenos multirresistentes sob vigilância epidemiológica e fornecer subsídios científicos para a revisão e o aprimoramento das práticas de limpeza e desinfecção hospitalar, visando reduzir as taxas de transmissão cruzada.
...
\subsection{Hipótese}
\begin{itemize}
    \item \textbf{Hipótese Geral:} Superfícies inanimadas secundárias de contato frequente no entorno do paciente (cortinas divisórias, grades de camas, suportes de soro e painéis de bombas de infusão), que não passam por desinfecção concorrente sistemática, apresentam contaminação significativa e atuam como reservatórios de bactérias multirresistentes sob vigilância epidemiológica (KPC, VRE e MRSA).
    \item \textbf{Hipóteses Secundárias:}
    \begin{enumerate}
        \item A presença de patógenos multirresistentes específicos difere significativamente entre as superfícies têxteis (cortinas), que propiciam maior aderência e sobrevivência de cocos Gram-positivos (como VRE e MRSA), e as superfícies poliméricas ou metálicas (grades, suportes e painéis), propícias a bacilos Gram-negativos multirresistentes (como CRE/KPC).
        \item A taxa de contaminação e a diversidade de microrganismos resistentes são maiores em superfícies localizadas na vizinhança imediata do paciente (grades de leito e cortinas divisórias), em comparação com superfícies de contato intermitente (suportes de soro e painéis de bombas).
...
Avaliar o perfil de contaminação ambiental e a presença de bactérias multirresistentes de importância epidemiológica crítica (especificamente enterobactérias produtoras de carbapenemase do tipo KPC, enterococos resistentes à vancomicina - VRE, e \textit{Staphylococcus aureus} resistente à meticilina - MRSA) em superfícies inanimadas de contato indireto e sob baixo monitoramento em enfermarias do Hospital de Clínicas da Universidade Federal de Uberlândia (HC-UFU), estimando o seu papel potencial como reservatórios ambientais de transmissão cruzada.

\section{Objetivos específicos}
\begin{enumerate}
    \item Rastrear e isolar especificamente bactérias multirresistentes (MRSA, VRE e CRE/KPC) a partir de amostras de swabs coletados em quatro tipos de superfícies inanimadas: cortinas de separação de leitos, grades de camas, suportes de soro e painéis de controle de bombas de infusão.
    \item Confirmar a identificação taxonômica das cepas multirresistentes isoladas por meio de coloração de Gram, testes enzimáticos e identificação bioquímica convencional.
...
Este é um estudo observacional transversal com abordagem descritiva e caráter analítico in vitro, focado no isolamento e na identificação microbiológica de bactérias a partir de superfícies inanimadas. O estudo será conduzido nas enfermarias clínicas e cirúrgicas adultas do Hospital de Clínicas da UFU (HC-UFU). As análises laboratoriais de cultivo, identificação bioquímica e testes de susceptibilidade antimicrobiana serão executadas nas dependências do Laboratório de Microbiologia do próprio Hospital de Clínicas da UFU.
...
\begin{enumerate}
    ...
    \item \textbf{Grades de cabeceira das camas:} Coleta na região superior e central da grade plástica ou metálica do leito ativo.
...
\subsection{Identificação taxonômica fenotípica}
A identificação das colônias suspeitas obtidas nos meios cromogênicos seguirá protocolos microbiológicos manuais estabelecidos para confirmação taxonômica:
\begin{enumerate}
    \item \textbf{Triagem Inicial:} Confirmação morfotintorial por coloração de Gram a partir de colônias isoladas nos meios seletivos.
    \item \textbf{Confirmação de Suspeitas de MRSA (Cocos Gram-positivos em cacho):}
    \begin{itemize}
        \item \textit{Teste de Catalase:} Positivo para confirmação de \textit{Staphylococcus} spp.
        \item \textit{Teste de Coagulase em tubo e lâmina:} Positivo para identificação confirmatória de \textit{Staphylococcus aureus}.
        \item \textit{Teste de DNase ou de aglutinação de látex:} Utilizados como testes auxiliares para a confirmação taxonômica da espécie.
    \end{itemize}
    \item \textbf{Confirmação de Suspeitas de VRE (Cocos Gram-positivos em pares/cadeias curtas):}
    \begin{itemize}
        \item \textit{Teste de Catalase:} Negativo, característico do gênero.
        \item \textit{Prova de Hidrólise da Bile Esculina e Crescimento em NaCl 6,5\%:} Positivos para identificação de \textit{Enterococcus} spp.
        \item \textit{Testes de fermentação de carboidratos (ex: Arabinose, Metil-alfa-D-glucopiranosídeo):} Para diferenciação entre \textit{Enterococcus faecium} (arabinose positivo) e \textit{Enterococcus faecalis} (arabinose negativo).
    \end{itemize}
    \item \textbf{Confirmação de Suspeitas de KPC/CRE (Bacilos Gram-negativos):}
    \begin{itemize}
        \item \textit{Teste de Oxidase:} Diferenciação de Enterobacterales (oxidase negativa) e não-fermentadores (\textit{Pseudomonas aeruginosa} oxidase positiva, \textit{Acinetobacter baumannii} oxidase negativa).
        \item \textit{Série Bioquímica Convencional (Meio Rugai modificado ou meios clássicos):} Inoculação em meios para verificação de produção de gás e sulfeto de hidrogênio (H\textsubscript{2}S), fermentação de glicose, sacarose e lactose (TSI), descarboxilação da lisina (LIA), motilidade e indol (MIO), utilização de citrato (Citrato de Simmons) e urease.
        \item \textit{Testes Fenotípicos de Triagem de Carbapenemase (Blue-Carba ou teste de inibição da carbapenemase com ácido borônico/EDTA):} Realizados para confirmar a produção de carbapenemase e diferenciar as classes (como KPC vs. metalobetalactamases).
    \end{itemize}
\end{enumerate}
...
A presente proposta de pesquisa caracteriza-se como um estudo in vitro de vigilância ambiental no qual as amostras microbiológicas são isoladas exclusivamente a partir de superfícies inanimadas coletivas e públicas instaladas no ambiente físico hospitalar (grades de cama, hastes de soro, painéis eletrônicos e cortinas). Não haverá qualquer coleta de fluidos biológicos humanos, aplicação de questionários, análise de prontuários clínicos, ou procedimentos de intervenção direta ou indireta em pacientes, acompanhantes ou profissionais de saúde.

Assim, de acordo com as diretrizes estabelecidas pelas Resoluções n\textsuperscript{o} 466/2012 e n\textsuperscript{o} 510/2016 do Conselho Nacional de Saúde (CNS), que dispõem sobre pesquisas envolvendo seres humanos no Brasil, o presente projeto não apresenta elements constitutivos que configurem pesquisa com seres humanos. Por conseguinte, este estudo não exige submissão ou tramitação para análise ética no Comitê de Ética em Pesquisa (CEP)/CONEP, permitindo a execução imediata das coletas de amostras a partir do início da vigência das atividades do projeto, desde que autorizada formalmente pela Diretoria de Ensino e Pesquisa do Hospital de Clínicas da UFU por meio da obtenção da Carta de Anuência Institucional (conforme Modelo em Anexo).
\newpage
...
\begin{enumerate}
    ...
    \item \textbf{Relação Epidemiológica de Riscos:} Compreender a distribuição espacial e a taxa de circulação ambiental dessas bactérias multirresistentes nas enfermarias ativas do Hospital de Clínicas da UFU (HC-UFU).
    ...
    \item \textbf{Subsídio a Protocolos de Barreira e Higiene:} Elaborar um relatório técnico analítico detalhado e direcionado à Comissão de Controle de Infecção Hospitalar (CCIH/SCIH) e ao Serviço de Higiene e Limpeza. Estes dados empíricos servirão de base para fundamentar a implantação de precauções de contato adicionais, revisão dos cronogramas de troca/lavagem de cortinas de leito e especificação dos saneantes ideais para desinfecção dos painéis eletrônicos e grades.
...
\begin{itemize}
    ...
    \item \textbf{Mês 6 a 8 (Fev/2027 a Abr/2027):} Isolamento bacteriano em meios cromogênicos seletivos (MRSA, VRE, KPC); realização de coloração de Gram; condução de testes fenotípicos de confirmação (catalase, coagulase, ensaios bioquímicos e testes de triagem enzimática para carbapenemase).
...
5. Confirmação bioquímica dos isolados & & & & & & X & X & X & & & & \\
...
\noindent Eu, \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_, na qualidade de Diretor(a) / Coordenador(a) do Serviço de Controle de Infecção Hospitalar / Direção de Ensino e Pesquisa do Hospital de Clínicas da Universidade Federal de Uberlândia (HC-UFU), declaro estar ciente dos termos da pesquisa intitulada \textbf{"Investigação de Bactérias Multirresistentes de Importância Epidemiológica em Superfícies Inanimadas Hospitalares de Contato Indireto como Potenciais Reservatórios Ambientais"}, sob responsabilidade da equipe científica cadastrada sob o Edital n\textsuperscript{o} 01/2026 da HU Brasil.

Declaro que esta instituição autoriza a coleta de dados microbiológicos por meio de swabs friccionados em superfícies inanimadas públicas de uso coletivo (grades de leitos, cortinas de leitos, suportes de soro e painéis de controle de bombas de infusão), em enfermarias sob jurisdição técnica desta administração.
...
\vspace{1cm}
\noindent Hospital de Clínicas da UFU, \_\_\_\_ de \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ de 2026.
...
\noindent \textbf{Identificador do Leito (Código):} \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ \hfill \textbf{Enfermaria / Setor:} \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ \\
...
\hline
GRD-\_\_\_\_\_\_ & Grade do Leito & & \\
\hline
